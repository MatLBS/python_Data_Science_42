...
def ft_rotate(path: str) -> list:
	"""
	This function loads an image from the specified path, zooms in on a specific region,
	converts it to grayscale, rotates it by 90 degrees anticlockwise, and displays the image.
	Args:
