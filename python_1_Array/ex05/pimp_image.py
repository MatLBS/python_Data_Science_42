...
def ft_red(array) -> list:
    """
    Extracts the red channel from the image and
    sets the green and blue channels to zero.
    Args:
        array (list): The image array.
    Returns:
...
def ft_green(array) -> list:
    """
    Extracts the green channel from the image and
    sets the red and blue channels to zero.
    Args:
        array (list): The image array.
    Returns:
...
def ft_blue(array) -> list:
    """
    Extracts the blue channel from the image and
    sets the red and green channels to zero.
    Args:
        array (list): The image array.
    Returns:
